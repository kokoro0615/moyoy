...
function createMeasuredConfig() {
  const frames = [
    ...
    createFrame("tablet-root", 768, 1024, "menu-closed", "root"),
    createFrame("tablet-dusk", 768, 1024, "menu-closed", "dusk"),
    createFrame("tablet-dawn", 768, 1024, "menu-closed", "dawn"),
    createFrame("tablet-alpine", 768, 1024, "menu-closed", "alpine"),
    createFrame("tablet-footer", 768, 1024, "menu-closed", "footer"),
    createFrame("mobile-root", 390, 844, "menu-closed", "root"),
    createFrame("mobile-dusk", 390, 844, "menu-closed", "dusk"),
    createFrame("mobile-dawn", 390, 844, "menu-closed", "dawn"),
    createFrame("mobile-alpine", 390, 844, "menu-closed", "alpine"),
    createFrame("mobile-footer", 390, 844, "menu-closed", "footer"),
  ...
  return {
    ...
    requiredCoverage: [
      ...
      coverage("tablet-root-dusk-dawn-alpine-footer", [
        "tablet-root",
        "tablet-dusk",
        "tablet-dawn",
        "tablet-alpine",
      ...
      coverage("mobile-root-dusk-dawn-alpine-footer", [
        "mobile-root",
        "mobile-dusk",
        "mobile-dawn",
        "mobile-alpine",
